...
It has these top-level messages:
	...
	ClusterIDError
	Error
	StreamBackupTaskSecurityConfig
	CipherInfo
	MasterKeyConfig
	BackupRequest
	...
	LogFileSubcompaction
	RegionMetaHint
	LogFileSubcompactions
	LogFileCompaction
	MetaEdit
	DeleteSpansOfFile
	Migration
...
func (PrepareSnapshotBackupRequestType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{0}
}
...
func (PrepareSnapshotBackupEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{1}
}
...
func (CompressionType) EnumDescriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{2} }
...
func (BackupMode) EnumDescriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{3} }
...
func (MetaVersion) EnumDescriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{4} }
...
func (FileType) EnumDescriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{5} }
...
func (*BackupMeta) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{2} }
...
func (*BackupRange) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{3} }
...
func (*File) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{4} }
...
func (*MetaFile) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{5} }
...
func (*PlacementPolicy) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{6} }
...
func (*StatsBlock) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{7} }
...
func (*StatsFile) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{8} }
...
func (*StatsFileIndex) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{9} }
...
func (*Schema) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{10} }
...
func (*IDMap) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{11} }
...
func (*PitrTableMap) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{12} }
...
func (*PitrDBMap) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{13} }
...
func (*RawRange) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{14} }
...
func (*ClusterIDError) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{15} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{16} }
...
func (*StreamBackupTaskSecurityConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{17}
}
...
type StreamBackupTaskSecurityConfig_PlaintextDataKey struct {
	PlaintextDataKey *CipherInfo `protobuf:"bytes,1,opt,name=plaintext_data_key,json=plaintextDataKey,oneof"`
}
type StreamBackupTaskSecurityConfig_MasterKeyConfig struct {
	MasterKeyConfig *MasterKeyConfig `protobuf:"bytes,2,opt,name=master_key_config,json=masterKeyConfig,oneof"`
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*StreamBackupTaskSecurityConfig) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _StreamBackupTaskSecurityConfig_OneofMarshaler, _StreamBackupTaskSecurityConfig_OneofUnmarshaler, _StreamBackupTaskSecurityConfig_OneofSizer, []interface{}{
		(*StreamBackupTaskSecurityConfig_PlaintextDataKey)(nil),
		(*StreamBackupTaskSecurityConfig_MasterKeyConfig)(nil),
	}
}

func _StreamBackupTaskSecurityConfig_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*StreamBackupTaskSecurityConfig)
	// encryption
	switch x := m.Encryption.(type) {
	case *StreamBackupTaskSecurityConfig_PlaintextDataKey:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PlaintextDataKey); err != nil {
			return err
		}
	case *StreamBackupTaskSecurityConfig_MasterKeyConfig:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.MasterKeyConfig); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("StreamBackupTaskSecurityConfig.Encryption has unexpected type %T", x)
	}
	return nil
}

func _StreamBackupTaskSecurityConfig_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*StreamBackupTaskSecurityConfig)
	switch tag {
	case 1: // encryption.plaintext_data_key
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CipherInfo)
		err := b.DecodeMessage(msg)
		m.Encryption = &StreamBackupTaskSecurityConfig_PlaintextDataKey{msg}
		return true, err
	case 2: // encryption.master_key_config
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(MasterKeyConfig)
		err := b.DecodeMessage(msg)
		m.Encryption = &StreamBackupTaskSecurityConfig_MasterKeyConfig{msg}
		return true, err
	default:
		return false, nil
	}
...
func _StreamBackupTaskSecurityConfig_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*StreamBackupTaskSecurityConfig)
	// encryption
	switch x := m.Encryption.(type) {
	case *StreamBackupTaskSecurityConfig_PlaintextDataKey:
		...
		n += s
	case *StreamBackupTaskSecurityConfig_MasterKeyConfig:
		s := proto.Size(x.MasterKeyConfig)
...
func (*CipherInfo) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{18} }
...
type MasterKeyConfig struct {
	...
	MasterKeys     []*encryptionpb.MasterKey     `protobuf:"bytes,2,rep,name=master_keys,json=masterKeys" json:"master_keys,omitempty"`
}
...
func (*MasterKeyConfig) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{19} }
...
func (*BackupRequest) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{20} }
...
type StreamBackupTaskInfo struct {
	...
	SecurityConfig *StreamBackupTaskSecurityConfig `protobuf:"bytes,7,opt,name=security_config,json=securityConfig" json:"security_config,omitempty"`
}
...
func (*StreamBackupTaskInfo) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{21} }
...
func (*StorageBackend) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{22} }
...
func (*Noop) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{23} }
...
func (*Local) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{24} }
...
func (*S3) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{25} }
...
func (*GCS) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{26} }
...
func (*AzureCustomerKey) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{27} }
...
func (*AzureBlobStorage) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{28} }
...
func (*Bucket) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{29} }
...
func (*CloudDynamic) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{30} }
...
func (*HDFS) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{31} }
...
func (*BackupResponse) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{32} }
...
func (*CleanupRequest) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{33} }
...
func (*CleanupResponse) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{34} }
...
func (*PrepareRequest) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{35} }
...
func (*PrepareResponse) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{36} }
...
func (*CheckAdminRequest) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{37} }
...
func (*CheckAdminResponse) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{38} }
...
func (*ExternalStorageRestoreRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{39}
}
...
func (*ExternalStorageRestoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{40}
}
...
func (*ExternalStorageSaveRequest) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{41} }
...
func (*ExternalStorageSaveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorBrpb, []int{42}
}
...
func (*Metadata) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{43} }
...
func (*DataFileGroup) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{44} }
...
type DataFileInfo struct {
	...
	RegionEpoch []*metapb.RegionEpoch `protobuf:"bytes,22,rep,name=region_epoch,json=regionEpoch" json:"region_epoch,omitempty"`
	// Encryption information of this data file, not set if plaintext.
	FileEncryptionInfo *encryptionpb.FileEncryptionInfo `protobuf:"bytes,23,opt,name=file_encryption_info,json=fileEncryptionInfo" json:"file_encryption_info,omitempty"`
}
...
func (*DataFileInfo) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{45} }
...
func (*StreamBackupError) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{46} }
...
func (*Span) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{47} }
...
func (*SpansOfFile) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{48} }
...
type LogFileSubcompactionMeta struct {
	...
	Sources []*SpansOfFile `protobuf:"bytes,12,rep,name=sources" json:"sources,omitempty"`
}
...
func (*LogFileSubcompactionMeta) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{49} }
...
type LogFileSubcompaction struct {
	...
	Meta *LogFileSubcompactionMeta `protobuf:"bytes,1,opt,name=meta" json:"meta,omitempty"`
	// The generated SSTs.
	SstOutputs []*File `protobuf:"bytes,2,rep,name=sst_outputs,json=sstOutputs" json:"sst_outputs,omitempty"`
	...
	RegionMetaHints []*RegionMetaHint `protobuf:"bytes,3,rep,name=region_meta_hints,json=regionMetaHints" json:"region_meta_hints,omitempty"`
}
...
func (*LogFileSubcompaction) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{50} }
...
func (*RegionMetaHint) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{51} }
...
type LogFileSubcompactions struct {
	Subcompactions []*LogFileSubcompaction `protobuf:"bytes,1,rep,name=subcompactions" json:"subcompactions,omitempty"`
}
...
func (*LogFileSubcompactions) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{52} }
...
func (*LogFileCompaction) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{53} }
...
type MetaEdit struct {
	...
	DeletePhysicalFiles []string `protobuf:"bytes,2,rep,name=delete_physical_files,json=deletePhysicalFiles" json:"delete_physical_files,omitempty"`
	...
	DeleteLogicalFiles []*DeleteSpansOfFile `protobuf:"bytes,3,rep,name=delete_logical_files,json=deleteLogicalFiles" json:"delete_logical_files,omitempty"`
...
func (*MetaEdit) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{54} }
...
func (*DeleteSpansOfFile) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{55} }
...
type Migration struct {
	EditMeta    []*MetaEdit          `protobuf:"bytes,1,rep,name=edit_meta,json=editMeta" json:"edit_meta,omitempty"`
	TruncatedTo uint64               `protobuf:"varint,2,opt,name=truncated_to,json=truncatedTo,proto3" json:"truncated_to,omitempty"`
	Compactions []*LogFileCompaction `protobuf:"bytes,3,rep,name=compactions" json:"compactions,omitempty"`
	// Delete all files matches this prefix.
	DestructPrefix []string `protobuf:"bytes,4,rep,name=destruct_prefix,json=destructPrefix" json:"destruct_prefix,omitempty"`
}
...
func (*Migration) Descriptor() ([]byte, []int) { return fileDescriptorBrpb, []int{56} }
...
func (c *backupClient) Backup(ctx context.Context, in *BackupRequest, opts ...grpc.CallOption) (Backup_BackupClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Backup_serviceDesc.Streams[0], c.cc, "/backup.Backup/backup", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *backupClient) CheckPendingAdminOp(ctx context.Context, in *CheckAdminRequest, opts ...grpc.CallOption) (Backup_CheckPendingAdminOpClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Backup_serviceDesc.Streams[1], c.cc, "/backup.Backup/CheckPendingAdminOp", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *backupClient) PrepareSnapshotBackup(ctx context.Context, opts ...grpc.CallOption) (Backup_PrepareSnapshotBackupClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Backup_serviceDesc.Streams[2], c.cc, "/backup.Backup/PrepareSnapshotBackup", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *backupClient) Prepare(ctx context.Context, in *PrepareRequest, opts ...grpc.CallOption) (*PrepareResponse, error) {
	...
	err := grpc.Invoke(ctx, "/backup.Backup/prepare", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backupClient) Cleanup(ctx context.Context, in *CleanupRequest, opts ...grpc.CallOption) (*CleanupResponse, error) {
	...
	err := grpc.Invoke(ctx, "/backup.Backup/cleanup", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *externalStorageClient) Restore(ctx context.Context, in *ExternalStorageRestoreRequest, opts ...grpc.CallOption) (*ExternalStorageRestoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/backup.ExternalStorage/restore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *externalStorageClient) Save(ctx context.Context, in *ExternalStorageSaveRequest, opts ...grpc.CallOption) (*ExternalStorageSaveResponse, error) {
	...
	err := grpc.Invoke(ctx, "/backup.ExternalStorage/save", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *StreamBackupTaskSecurityConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Encryption != nil {
		nn13, err := m.Encryption.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
...
func (m *StreamBackupTaskSecurityConfig_PlaintextDataKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PlaintextDataKey != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.PlaintextDataKey.Size()))
		n14, err := m.PlaintextDataKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *StreamBackupTaskSecurityConfig_MasterKeyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MasterKeyConfig != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.MasterKeyConfig.Size()))
		n15, err := m.MasterKeyConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *BackupRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageBackend != nil {
		...
		n16, err := m.StorageBackend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.CipherInfo != nil {
		...
		n17, err := m.CipherInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *StreamBackupTaskInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecurityConfig != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.SecurityConfig.Size()))
		n20, err := m.SecurityConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *StorageBackend) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Backend != nil {
		nn21, err := m.Backend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn21
...
func (m *StorageBackend_Noop) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Noop != nil {
		...
		n22, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *StorageBackend_Gcs) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Gcs != nil {
		...
		n25, err := m.Gcs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *StorageBackend_CloudDynamic) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CloudDynamic != nil {
		...
		n26, err := m.CloudDynamic.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *StorageBackend_Hdfs) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Hdfs != nil {
		...
		n27, err := m.Hdfs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *StorageBackend_AzureBlobStorage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AzureBlobStorage != nil {
		...
		n28, err := m.AzureBlobStorage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *AzureBlobStorage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EncryptionKey != nil {
		...
		n29, err := m.EncryptionKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *CloudDynamic) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Bucket != nil {
		...
		n30, err := m.Bucket.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *ExternalStorageRestoreRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageBackend != nil {
		...
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.StorageBackend.Size()))
		n36, err := m.StorageBackend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *ExternalStorageSaveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageBackend != nil {
		...
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.StorageBackend.Size()))
		n37, err := m.StorageBackend.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *DataFileInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RegionStartKey) > 0 {
		...
		i += copy(dAtA[i:], m.RegionStartKey)
	}
	if len(m.RegionEndKey) > 0 {
		...
		i += copy(dAtA[i:], m.RegionEndKey)
	}
	if len(m.RegionEpoch) > 0 {
		for _, msg := range m.RegionEpoch {
			dAtA[i] = 0xb2
			i++
			dAtA[i] = 0x1
			i++
	...
	if m.FileEncryptionInfo != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.FileEncryptionInfo.Size()))
		n38, err := m.FileEncryptionInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *LogFileSubcompaction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Meta != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.Meta.Size()))
	...
	if len(m.RegionMetaHints) > 0 {
		for _, msg := range m.RegionMetaHints {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintBrpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *RegionMetaHint) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RegionEpoch != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintBrpb(dAtA, i, uint64(m.RegionEpoch.Size()))
...
func (m *LogFileSubcompactions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Subcompactions) > 0 {
		for _, msg := range m.Subcompactions {
			dAtA[i] = 0xa
			i++
			i = encodeVarintBrpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *LogFileCompaction) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GeneratedFiles) > 0 {
		...
		i += copy(dAtA[i:], m.GeneratedFiles)
	}
	return i, nil
}
...
func (m *MetaEdit) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DeleteLogicalFiles) > 0 {
		for _, msg := range m.DeleteLogicalFiles {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintBrpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func init() { proto.RegisterFile("brpb.proto", fileDescriptorBrpb) }

var fileDescriptorBrpb = []byte{
	...
	,
}
