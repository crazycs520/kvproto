...
/*
Package deadlock is a generated protocol buffer package.
...
func (DeadlockRequestType) EnumDescriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{0} }
...
func (*WaitForEntriesRequest) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{0} }
...
func (*WaitForEntriesResponse) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{1} }
...
func (*WaitForEntry) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{2} }
...
func (*ReplaceLockByKeyItem) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{3} }
...
type ReplaceLocksByKeysRequest struct {
	Items []*ReplaceLockByKeyItem `protobuf:"bytes,1,rep,name=items" json:"items,omitempty"`
}
...
func (*ReplaceLocksByKeysRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorDeadlock, []int{4}
}
...
type DeadlockRequest struct {
	...
	ReplaceLocksByKeys *ReplaceLocksByKeysRequest `protobuf:"bytes,3,opt,name=replace_locks_by_keys,json=replaceLocksByKeys" json:"replace_locks_by_keys,omitempty"`
}
...
func (*DeadlockRequest) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{5} }
...
func (*DeadlockResponse) Descriptor() ([]byte, []int) { return fileDescriptorDeadlock, []int{6} }
...
func (c *deadlockClient) GetWaitForEntries(ctx context.Context, in *WaitForEntriesRequest, opts ...grpc.CallOption) (*WaitForEntriesResponse, error) {
	...
	err := grpc.Invoke(ctx, "/deadlock.Deadlock/GetWaitForEntries", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deadlockClient) Detect(ctx context.Context, opts ...grpc.CallOption) (Deadlock_DetectClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Deadlock_serviceDesc.Streams[0], c.cc, "/deadlock.Deadlock/Detect", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *DeadlockRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReplaceLocksByKeys != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintDeadlock(dAtA, i, uint64(m.ReplaceLocksByKeys.Size()))
		n2, err := m.ReplaceLocksByKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func init() { proto.RegisterFile("deadlock.proto", fileDescriptorDeadlock) }

var fileDescriptorDeadlock = []byte{
	// 588 bytes of a gzipped FileDescriptorProto
	,
}
