...
type StaleReadOption int32

const (
	// Disable indicates this is not a stale-read request.
	StaleReadOption_Disable StaleReadOption = 0
	// Enable indicates this is a stale-read request.
	StaleReadOption_Enable StaleReadOption = 1
	// Fallback indicates this is a stale-read request, but it failed the first time,
	// then retry and fallback to leader read or follower read or something else.
	StaleReadOption_Fallback StaleReadOption = 2
)

var StaleReadOption_name = map[int32]string{
	0: "Disable",
	1: "Enable",
	2: "Fallback",
}
var StaleReadOption_value = map[string]int32{
	"Disable":  0,
	"Enable":   1,
	"Fallback": 2,
}

func (x StaleReadOption) String() string {
	return proto.EnumName(StaleReadOption_name, int32(x))
}
func (StaleReadOption) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{3} }
...
func (CommandPri) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{4} }
...
func (IsolationLevel) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{5} }
...
func (DiskFullOpt) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{6} }
...
func (Op) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{7} }
...
func (Assertion) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{8} }
...
func (AssertionLevel) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{9} }
...
func (Action) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{10} }
...
func (ExtraOp) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{11} }
...
func (ChecksumAlgorithm) EnumDescriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{12} }
...
func (m *TxnHeartBeatRequest) GetMinCommitTs() uint64 {
	if m != nil {
		return m.MinCommitTs
	}
	return 0
...
type SplitRegionResponse struct {
	...
	// Reserved for file based transaction.
	Errors []*KeyError `protobuf:"bytes,100,rep,name=errors" json:"errors,omitempty"`
}
...
type Context struct {
	...
	StaleRead StaleReadOption `protobuf:"varint,17,opt,name=stale_read,json=staleRead,proto3,enum=kvrpcpb.StaleReadOption" json:"stale_read,omitempty"`
...
func (m *Context) GetStaleRead() StaleReadOption {
	if m != nil {
		return m.StaleRead
	}
	return StaleReadOption_Disable
}
...
func (*FlushRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{131} }
...
func (*FlushResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{132} }
...
func (*BufferBatchGetRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{133} }
...
func (*BufferBatchGetResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{134} }
...
func (m *GetHealthFeedbackRequest) Reset()         { *m = GetHealthFeedbackRequest{} }
func (m *GetHealthFeedbackRequest) String() string { return proto.CompactTextString(m) }
func (*GetHealthFeedbackRequest) ProtoMessage()    {}
func (*GetHealthFeedbackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorKvrpcpb, []int{135}
}
...
type GetHealthFeedbackResponse struct {
	...
	RegionError    *errorpb.Error  `protobuf:"bytes,1,opt,name=region_error,json=regionError" json:"region_error,omitempty"`
	HealthFeedback *HealthFeedback `protobuf:"bytes,2,opt,name=health_feedback,json=healthFeedback" json:"health_feedback,omitempty"`
}

func (m *GetHealthFeedbackResponse) Reset()         { *m = GetHealthFeedbackResponse{} }
func (m *GetHealthFeedbackResponse) String() string { return proto.CompactTextString(m) }
func (*GetHealthFeedbackResponse) ProtoMessage()    {}
func (*GetHealthFeedbackResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorKvrpcpb, []int{136}
}
...
func (m *HealthFeedback) Reset()                    { *m = HealthFeedback{} }
func (m *HealthFeedback) String() string            { return proto.CompactTextString(m) }
func (*HealthFeedback) ProtoMessage()               {}
func (*HealthFeedback) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{137} }
...
type BroadcastTxnStatusRequest struct {
	Context   *Context     `protobuf:"bytes,1,opt,name=context" json:"context,omitempty"`
	TxnStatus []*TxnStatus `protobuf:"bytes,2,rep,name=txn_status,json=txnStatus" json:"txn_status,omitempty"`
}

func (m *BroadcastTxnStatusRequest) Reset()         { *m = BroadcastTxnStatusRequest{} }
func (m *BroadcastTxnStatusRequest) String() string { return proto.CompactTextString(m) }
func (*BroadcastTxnStatusRequest) ProtoMessage()    {}
func (*BroadcastTxnStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorKvrpcpb, []int{138}
}
...
func (*TxnStatus) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{139} }
...
func (m *TxnStatus) GetRolledBack() bool {
	if m != nil {
		return m.RolledBack
	}
	return false
...
func (m *TxnStatus) GetIsCompleted() bool {
	if m != nil {
...
func (m *BroadcastTxnStatusResponse) Reset()         { *m = BroadcastTxnStatusResponse{} }
func (m *BroadcastTxnStatusResponse) String() string { return proto.CompactTextString(m) }
func (*BroadcastTxnStatusResponse) ProtoMessage()    {}
func (*BroadcastTxnStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorKvrpcpb, []int{140}
}
...
func init() {
	...
	proto.RegisterType((*GetHealthFeedbackRequest)(nil), "kvrpcpb.GetHealthFeedbackRequest")
	proto.RegisterType((*GetHealthFeedbackResponse)(nil), "kvrpcpb.GetHealthFeedbackResponse")
	proto.RegisterType((*HealthFeedback)(nil), "kvrpcpb.HealthFeedback")
	proto.RegisterType((*BroadcastTxnStatusRequest)(nil), "kvrpcpb.BroadcastTxnStatusRequest")
	proto.RegisterType((*TxnStatus)(nil), "kvrpcpb.TxnStatus")
	proto.RegisterType((*BroadcastTxnStatusResponse)(nil), "kvrpcpb.BroadcastTxnStatusResponse")
	...
	proto.RegisterEnum("kvrpcpb.StaleReadOption", StaleReadOption_name, StaleReadOption_value)
...
func (m *Context) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StaleRead != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.StaleRead))
	}
...
func (m *Deadlock) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DeadlockKey) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(len(m.DeadlockKey)))
		i += copy(dAtA[i:], m.DeadlockKey)
	}
	return i, nil
}
...
func (m *GetHealthFeedbackRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Context != nil {
		...
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Context.Size()))
		n170, err := m.Context.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n170
...
func (m *GetHealthFeedbackResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RegionError != nil {
		...
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.RegionError.Size()))
		n171, err := m.RegionError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n171
	...
	if m.HealthFeedback != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.HealthFeedback.Size()))
		n172, err := m.HealthFeedback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n172
...
func (m *HealthFeedback) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FeedbackSeqNo != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.FeedbackSeqNo))
	}
	if m.SlowScore != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.SlowScore))
	}
	return i, nil
}
...
func (m *BroadcastTxnStatusRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Context != nil {
		...
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.Context.Size()))
		n173, err := m.Context.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n173
...
func (m *Context) Size() (n int) {
	...
	if m.StaleRead != 0 {
		n += 2 + sovKvrpcpb(uint64(m.StaleRead))
	}
...
func (m *HealthFeedback) Size() (n int) {
	...
	if m.FeedbackSeqNo != 0 {
		n += 1 + sovKvrpcpb(uint64(m.FeedbackSeqNo))
	}
	if m.SlowScore != 0 {
		n += 1 + sovKvrpcpb(uint64(m.SlowScore))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 17:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StaleRead |= (StaleReadOption(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GetHealthFeedbackRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetHealthFeedbackRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetHealthFeedbackRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetHealthFeedbackResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetHealthFeedbackResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetHealthFeedbackResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.HealthFeedback == nil {
				m.HealthFeedback = &HealthFeedback{}
			}
...
func (m *HealthFeedback) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HealthFeedback: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HealthFeedback: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FeedbackSeqNo", wireType)
			}
			m.FeedbackSeqNo = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FeedbackSeqNo |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SlowScore |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BroadcastTxnStatusRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BroadcastTxnStatusRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BroadcastTxnStatusRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BroadcastTxnStatusResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BroadcastTxnStatusResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BroadcastTxnStatusResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
